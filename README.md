...
### 🔧 Notable Projects
- 🌾 **Crop AI App** – Gemini-powered crop disease detector to be used by 1000+ farmers  
- 📁 **Cloud Drive** – Fast, secure web-based file storage  
- 🍽️ **Catering Platform** – Full-stack booking system for caterers and services  
- 💬 **Chat App** – Real-time chat with notifications  
- 🌐 **Portfolio Site** – Engaging personal site with 1K+ monthly visitors  
